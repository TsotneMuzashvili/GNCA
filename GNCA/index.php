...
<section class="posts-container">
   ...
   <h1 class="heading">უახლესი პოსტები</h1>
   ...
   <div class="box-container">
      ...
      <?php
         ...
         echo '<p class="empty">ჯერ ჯერობით არ არის ახალი პოსტი</p>';
      }
      ?>
   </div>

   <div class="more-btn" style="text-align: center; margin-top:1rem;">
      <a href="posts.php" class="inline-btn">ყველა პოსტის ნახვა</a>
   </div>
